...
/*
    ...
    function navbar_function(){
        document.querySelector('.menubar').classList.toggle('opennav');
        document.querySelector('.menubtn').classList.toggle('change');
        layer.classList.toggle("layeropen");
        
        if (document.querySelector(".menubtn").innerHTML.trim() == "☰") {
            document.querySelector(".menubtn").innerHTML = "✖";
        } else {
            document.querySelector(".menubtn").innerHTML = "☰";
        }
    ...
    open.addEventListener('click', navbar_function);
    layer.addEventListener("click", navbar_function);
